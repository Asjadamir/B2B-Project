...
const employeeRoutes = (controllers) => {
    const { getMyRole, sendInvite, getInviteInfo, acceptInvite, cancelInvite, getEmployees, getPendingInvites, updateRole, expel, leave } = controllers;
    ...
    router.delete("/invites/:requestId",   authMiddleware, cancelInvite);
