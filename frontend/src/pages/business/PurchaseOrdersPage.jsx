...
import {
    fetchPurchaseOrders,
    updatePurchaseOrderStatusThunk,
} from "@/store/purchaseOrderSlice.js";
...
export default function PurchaseOrdersPage() {
    ...
    async function handleStatusUpdate(orderId, status) {
        const r = await dispatch(
            updatePurchaseOrderStatusThunk({ id: orderId, status }),
        );
        if (!r.error) {
    ...
    return (
        <div className="p-6 space-y-5 max-w-5xl mx-auto">
            <div className="flex items-center justify-between gap-4">
                ...
                <Button
                    onClick={() =>
                        navigate(`/business/${id}/purchase-orders/new`)
                    }
                >
                        ...
                        {loading ? (
                                    ...
                                    <div className="flex flex-col items-center gap-3">
                                        ...
                                        {orders.length === 0 && (
                                            <Button
                                                ...
                                                onClick={() =>
                                                    navigate(
                                                        `/business/${id}/purchase-orders/new`,
                                                    )
                                                }
                                            >
                            ...
                            filtered.map((o) => (
                                <TableRow
                                    ...
                                    onClick={() =>
                                        navigate(
                                            `/business/${id}/purchase-orders/${o.POID}`,
                                        )
                                    }
                                >
                                                    ...
                                                    <Button
                                                        ...
                                                        onClick={() =>
                                                            setConfirmAction({
                                                                id: o.POID,
                                                                status: "Received",
                                                                label: `PO-${String(o.POID).padStart(4, "0")}`,
                                                            })
                                                        }
                                                    >
