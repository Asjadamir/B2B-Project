...
import {
    ...
    fetchWarehouseStaff,
    assignWarehouseStaffThunk,
    updateWarehouseStaffRoleThunk,
    removeWarehouseStaffThunk,
...
export default function WarehouseDetailPage() {
    ...
    const availableEmployees = employees.filter(
        (e) => !assignedStaffIds.has(e.StaffID),
    );
        ...
        <div className="p-6 max-w-4xl mx-auto space-y-6">
            <div className="flex items-center gap-3">
                <Button
                    ...
                    onClick={() => navigate(`/business/${id}/warehouses`)}
                >
            ...
            >
                <DialogContent className="sm:max-w-sm">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Assign an employee to this warehouse with a role.
                        </DialogDescription>
                    </DialogHeader>
                    <form
            ...
            >
                <DialogContent className="sm:max-w-sm">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Change role for{" "}
                            {editStaff?.FullName || editStaff?.Email}.
                        </DialogDescription>
                    </DialogHeader>
                    <form
                    ...
                    >
                        <div className="space-y-1.5">
                            ...
                            <Select
                                value={watchRole("roleId")}
                                onValueChange={(v) => setRoleValue("roleId", v)}
                            >
                                <SelectTrigger>
                                    <SelectValue placeholder="Select role" />
                                </SelectTrigger>
