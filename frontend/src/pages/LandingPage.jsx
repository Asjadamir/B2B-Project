        ...
        <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
            ...
            <section className="relative overflow-hidden pt-20 pb-28 px-6">
                ...
                >
                    ...
                    >
                        <Zap className="size-3" /> B2B Inventory &amp; Supply
                        Chain Platform
                    </motion.div>
                    ...
                    >
                        CoreChain unifies your suppliers, inventory, orders, and
                        warehouses — delivering real-time visibility to reduce
                        waste, prevent stockouts, and improve profitability.
                    </motion.p>
                    ...
                    >
                        ...
                        >
                            <Button
                                size="lg"
                                asChild
                                className="w-full sm:w-auto gap-2 shadow-lg shadow-primary/25 hover:shadow-primary/35 transition-shadow"
                            >
                                <Link to="/signup">
                                    Start for Free{" "}
                ...
                <div className="max-w-6xl mx-auto">
                    <FadeUp className="text-center space-y-3 mb-14">
                        ...
                        <p className="text-muted-foreground max-w-xl mx-auto">
                            ...
                            CoreChain brings every workflow into one unified
                            platform.
                        </p>
                    </FadeUp>
                ...
                <FadeUp>
                    <div className="max-w-3xl mx-auto text-center rounded-2xl border border-primary/20 bg-primary/5 p-12 space-y-5 relative overflow-hidden">
                        ...
                        <p className="text-muted-foreground max-w-md mx-auto">
                            Join businesses already using CoreChain to get
                            real-time control over their entire supply chain.
                        </p>
                        <motion.div
            ...
            <footer className="border-t border-border/60 py-8 px-6">
                <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
                    ...
                    <p>
                        © {new Date().getFullYear()} CoreChain. All rights
                        reserved.
                    </p>
